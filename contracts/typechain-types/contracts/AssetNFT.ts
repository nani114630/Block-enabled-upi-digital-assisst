...
export interface AssetNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "batchMintAsset",
...
export interface AssetNFT extends BaseContract {
  ...
  batchMintAsset: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "batchMintAsset"
  ): TypedContractMethod<
    [to: AddressLike, metadataURIs: string[]],
    [bigint],
    "nonpayable"
  ...
  ): TypedContractMethod<[newContractURI: string], [void], "nonpayable">;
  getFunction(
  ...
  filters: {
    ...
    "AssetMinted(address,uint256,string)": TypedContractEvent<
      AssetMintedEvent.InputTuple,
      AssetMintedEvent.OutputTuple,
      AssetMintedEvent.OutputObject
    >;
    ...
    "AssetTransferred(address,address,uint256)": TypedContractEvent<
      AssetTransferredEvent.InputTuple,
      AssetTransferredEvent.OutputTuple,
      AssetTransferredEvent.OutputObject
    >;
